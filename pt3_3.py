...
add_adsorbate(pt111_with_h, adsorbate3, 2.8, position=(0.00,0.0),offset= (0,2))

adsorbate4 = adsorbate2
adsorbate4.rotate(-120,'z' )
add_adsorbate(pt111_with_h, adsorbate4, 2.8, position=(0.00,0.0),offset= (1,2))

adsorbate5 = adsorbate3
adsorbate5.rotate(-120,'z' )
add_adsorbate(pt111_with_h, adsorbate3, 2.8, position=(0.00,0.0),offset= (2,1))

adsorbate6 = adsorbate4
adsorbate6.rotate(-120,'z' )
add_adsorbate(pt111_with_h, adsorbate4, 2.8, position=(0.00,0.0),offset= (2,0))
